...
function playGame (player) {
    ...
    if (player === undefined){
        ...
        logoPlayer.src = `logos/${options[player]}.png`
        logoBot.src = `./logos/${options[bot]}.png`
        logoDraw.src = './logos/empate.png'
